...
def main(precision: str):
    ...
    with torch.inference_mode():
        ...
        nunchakutextencoderloaderv2_48 = nunchakutextencoderloaderv2.load_text_encoder(
            ...
            text_encoder2="awq-int4-flux.1-t5xxl.safetensors",
            t5_min_length=512,
        )

        cliptextencode = NODE_CLASS_MAPPINGS["CLIPTextEncode"]()
        cliptextencode_6 = cliptextencode.encode(
            text='a cyberpunk cat holding a neon sign that says "Nunchaku is fast!"',
        ...
        randomnoise_25 = randomnoise.get_noise(noise_seed=993488991554872)
