...
def main(precision: str):
    ...
    with torch.inference_mode():
        ...
        cliptextencode_23 = cliptextencode.encode(
            text="A robot made of exotic candies and chocolates of different kinds. The background is filled with confetti and celebratory gifts.",
        ...
        nunchakufluxditloader_39 = nunchakufluxditloader.load_model(
            model_path=f"svdq-{precision}_r32-flux.1-canny-dev.safetensors",
            cache_threshold=0,
        ...
        for q in range(1):
            ksampler_3 = ksampler.sample(
                seed=10883237468670203103,
                steps=20,
                cfg=1,
                sampler_name="euler",
                scheduler="normal",
                denoise=1,
                model=get_value_at_index(nunchakufluxditloader_39, 0),
