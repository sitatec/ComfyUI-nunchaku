...
def main(precision: str):
    ...
    with torch.inference_mode():
        ...
        loadimage_17 = loadimage.load_image(image="removal.png")

        cliptextencode_23 = cliptextencode.encode(text="", clip=get_value_at_index(dualcliploader_34, 0))
        ...
        nunchakufluxditloader_59 = nunchakufluxditloader.load_model(
            model_path=f"svdq-{precision}-flux.1-fill-dev",
            cache_threshold=0,
        ...
        for q in range(1):
            nunchakufluxloraloader_60 = nunchakufluxloraloader.load_lora(
                lora_name="removalV2.safetensors",
            ...
            ksampler_3 = ksampler.sample(
                ...
                scheduler="normal",
                denoise=1,
                model=get_value_at_index(nunchakufluxloraloader_60, 0),
